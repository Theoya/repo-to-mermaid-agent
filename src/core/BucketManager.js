...
const TokenCalculator_1 = require("./TokenCalculator");
class BucketManager {
    constructor(maxTokensPerBucket, tokenThreshold = 0.9) {
        this.skippedFiles = [];
        this.tokenCalculator = new TokenCalculator_1.TokenCalculator();
     ...
     */
    createBucket(files, totalTokens) {
        return {
            files,
     ...
     */
    removeFileFromBucket(bucket, filePath) {
     ...
     */
    processFilesWithSplitting(files) {
