...
class TokenCalculator {
     ...
     */
    calculatePromptTokens(template, variables) {
        let prompt = template;
     ...
     */
    calculateMessageTokens(systemMessage, userMessage) {
