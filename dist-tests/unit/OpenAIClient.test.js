...
describe('OpenAIClient', () => {
    ...
    let mockBucket;
    beforeEach(() => {
        openAIClient = new OpenAIClient_1.OpenAIClient('test-api-key', 'gpt-4', 1000, 0.1);
        mockFiles = [
            {
                path: 'test.js',
    ...
    describe('constructor', () => {
        it('should initialize with correct parameters', () => {
            const client = new OpenAIClient_1.OpenAIClient('test-key', 'gpt-3.5-turbo', 2000, 0.5);
    ...
    describe('estimateCost', () => {
        it('should estimate cost for gpt-4', () => {
            const client = new OpenAIClient_1.OpenAIClient('test-key', 'gpt-4');
        ...
        it('should estimate cost for gpt-3.5-turbo', () => {
            const client = new OpenAIClient_1.OpenAIClient('test-key', 'gpt-3.5-turbo');
            const cost = client.estimateCost(1000, 500);
        ...
        it('should use default pricing for unknown models', () => {
            const client = new OpenAIClient_1.OpenAIClient('test-key', 'unknown-model');
            const cost = client.estimateCost(1000, 500);
